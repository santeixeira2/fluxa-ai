    ...
    <div className="fixed top-0 left-0 right-0 z-50">
      <nav className="bg-white/60 dark:bg-[#000000]/60 backdrop-blur-2xl border-b border-black/[0.05] dark:border-white/[0.05] relative z-[2]">
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8" aria-label="main-nav">
          ...
          {user && (
            <div className="relative" ref={notifRef}>
              ...
              {showNotif && (
                <div className="absolute top-full right-0 mt-2 w-[min(320px,calc(100vw-1rem))] bg-white dark:bg-[#0a0a0a] border border-black/10 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50">
          ...
          <div className="flex items-center gap-4 relative" ref={menuRef}>
            ...
            <div className="absolute top-full right-0 w-[min(260px,calc(100vw-1rem))] md:w-full bg-white dark:bg-[#0a0a0a] border border-black/[0.1] dark:border-white/[0.1] border-t-0 rounded-b-2xl p-2 shadow-2xl z-[300] animate-fade-down overflow-y-auto max-h-[80vh]">
                ...
                <div className="md:hidden border-b border-black/[0.05] dark:border-white/[0.05] mb-1 pb-1">
                  <Link to="/" onClick={() => setShowMenu(false)} className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm text-black/70 dark:text-white/70 hover:bg-black/10 dark:hover:bg-white/10 transition-colors">{t('nav.home')}</Link>
                  <Link to="/calculadoras" onClick={() => setShowMenu(false)} className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm text-black/70 dark:text-white/70 hover:bg-black/10 dark:hover:bg-white/10 transition-colors">{t('nav.calculadoras')}</Link>
                  {user && <Link to="/analysis" onClick={() => setShowMenu(false)} className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm text-black/70 dark:text-white/70 hover:bg-black/10 dark:hover:bg-white/10 transition-colors">{t('nav.analysis')}</Link>}
                </div>
